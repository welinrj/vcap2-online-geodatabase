      ...
      <div className="dash-30x30-notes">
        <div className="dash-30x30-notes-grid">
          <div className="dash-30x30-note">
            <Icons8Icon name="goal" size={22} className="dash-30x30-note-icon" />
            <div>
          ...
          <div className="dash-30x30-note">
            <Icons8Icon name="deciduous-tree" size={22} className="dash-30x30-note-icon" />
            <div>
          ...
          <div className="dash-30x30-note">
            <Icons8Icon name="fish" size={22} className="dash-30x30-note-icon" />
            <div>
          ...
          <div className="dash-30x30-note">
            <Icons8Icon name="activity" size={22} className="dash-30x30-note-icon" />
            <div>
